...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.MissionPreviewListDTO> getMissionList(@PathVariable @ExistStore Long id, @RequestParam(name = "page") Integer page) {
        Page<Mission> missionList=storeCommandService.getMissionList(id,page);
