...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -82563921L;
    ...
    public final umc.study.springboot.domain.QMember member;

    public final umc.study.springboot.domain.QMission mission;

    public final EnumPath<umc.study.springboot.domain.enums.MissionStatus> status = createEnum("status", umc.study.springboot.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.study.springboot.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.study.springboot.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
